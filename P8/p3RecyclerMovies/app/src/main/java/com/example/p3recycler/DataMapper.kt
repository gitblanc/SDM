...
import com.example.p3recycler.remote.data.MovieData
...
object DataMapper {
    ...
    fun convertToDomain(peliculas: MovieListData): List<Pelicula> {
     ...
     * urlTrailer
     */
    fun convertMovieListToDomain(movieData: List<MovieData>): List<Pelicula> {
